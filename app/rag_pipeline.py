...
from app.prompt import QA_PROMPT_TEMPLATE, SYSTEM_PROMPT
...
class RAGPipeline:
    ...
    def __init__(self, vectorstore: Chroma):
        ...
        self.store: dict[str, InMemoryChatMessageHistory] = {}  # stores chat history per session_id
    ...
    def _build_llm(self) -> ChatGoogleGenerativeAI:
        return ChatGoogleGenerativeAI(
            model=Config.GEMINI_MODEL, max_tokens=Config.MAX_TOKENS, temperature=Config.TEMPERATURE
        )
    ...
    def query(self, question: str, session_id: str) -> dict:
        ...
        return {"answer": response, "sources": source_docs}
